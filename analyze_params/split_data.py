...
# output_file_name = '/nas/datasets/yixin/PCMA/sim_data/splited_data_qpsk.pth'
path = '/nas/datasets/LYX/PCMA/8PSK_16/1050/'
original_file_name = '1050000000_20000000__24000000_20250623162534_672204_0000.dat'
output_file_name = '/nas/datasets/yixin/PCMA/sim_data/splited_data_8psk.pth'
# path = '/nas/datasets/LYX/PCMA/16QAM_16/1050/'
# original_file_name = '1050000000_20000000__24000000_20250623165125_802081_0000.dat'
# output_file_name = '/nas/datasets/yixin/PCMA/sim_data/splited_data_16qam.pth'
...
for N in N_list:
    ...
    output_file = output_file_name.split('.pth')[0] + f'_{N//3072}x3072.pth'
