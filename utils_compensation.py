...
def compare_psd(original, reconstructed, fs, title_prefix="linear_compensation"):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f'./src/splited_data/{title_prefix}_psd_comparison.png')
...
def compare_evm(original_data, reconstructed_data, sps, best_offset,title_prefix="EVM_Comparison"):
    ...
    plt.tight_layout()
    plt.savefig(f'./src/splited_data/{title_prefix}_constellation_comparison.png')
...
def analyze_error_signal(original, reconstructed):
    ...
    plt.tight_layout()
    plt.savefig('./src/splited_data/error_signal_analysis.png')
